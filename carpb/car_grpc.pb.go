...
type CarServiceClient interface {
	...
	ChangeCarStatus(ctx context.Context, in *ChangeCarStatusRequest, opts ...grpc.CallOption) (*CarResponse, error)
}
...
func (c *carServiceClient) CheckAvailability(ctx context.Context, in *CheckAvailabilityRequest, opts ...grpc.CallOption) (*CheckAvailabilityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *carServiceClient) ChangeCarStatus(ctx context.Context, in *ChangeCarStatusRequest, opts ...grpc.CallOption) (*CarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CarResponse)
	err := c.cc.Invoke(ctx, CarService_ChangeCarStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CarServiceServer interface {
	...
	ChangeCarStatus(context.Context, *ChangeCarStatusRequest) (*CarResponse, error)
...
func (UnimplementedCarServiceServer) CheckAvailability(context.Context, *CheckAvailabilityRequest) (*CheckAvailabilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckAvailability not implemented")
}
func (UnimplementedCarServiceServer) ChangeCarStatus(context.Context, *ChangeCarStatusRequest) (*CarResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeCarStatus not implemented")
}
...
func _CarService_CheckAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarServiceServer).CheckAvailability(ctx, req.(*CheckAvailabilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CarService_ChangeCarStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeCarStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CarServiceServer).ChangeCarStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CarService_ChangeCarStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarServiceServer).ChangeCarStatus(ctx, req.(*ChangeCarStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CarService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeCarStatus",
			Handler:    _CarService_ChangeCarStatus_Handler,
		},
	},
